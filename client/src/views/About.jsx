...
export default function About() {
  ...
  return (
    <>
      <div className=" min-h-screen flex items-center justify-around flex-wrap sm:flex-nowrap pt-16" id="about">
        <div
         
          className="flex flex-col items-center md:items-start justify-center  md:w-[50%] md:max-w-[60%] "
        >
          ...
          <img src={image} alt="" className="flex items-center justify-center md:hidden w-[220px] md:w-[250px] pt-10"/>

        </div>
        <div>
          <img src={image} alt="" className="hidden md:block w-[220px] md:w-[250px]"/>
        </div>
      </div>
    </>
  );
